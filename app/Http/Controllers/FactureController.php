...
class FactureController extends Controller
{
    ...
    public function getAllFactures(){
       ...
       public function getFacturesCompte($idCompte){
        ...
        $factures = Facture::leftJoin('comptes', 'factures.fk_compte_f', '=', 'comptes.id_compte')
        ->leftJoin('bon_livraisons','factures.fk_bl', '=', 'bon_livraisons.reference_bl')
        ->leftJoin('status', 'factures.fk_status_f', '=', 'status.id_status')
                    ->select('factures.*', 'comptes.nom_compte','status.*','bon_livraisons.*')
...
public function getBonLivraisonBL($id_bl){
        // $bonLivraison= BonLivraison::find($id_bl);
         $bonLivraison= bonLivraison::leftJoin('boncommandes', 'bon_livraisons.fk_bonCommande', '=', 'boncommandes.reference_bc')
         ->leftJoin('comptes', 'bon_livraisons.fk_compte_bl', '=', 'comptes.id_compte')
               ->leftJoin('macompagnies', 'comptes.fk_compagnie', '=', 'macompagnies.id_compagnie')
               ->leftJoin('mode_paiements', 'bon_livraisons.reference_bl', '=', 'mode_paiements.fk_document')
               ...
               ->select('bon_livraisons.*','comptes.*','status.*', 'macompagnies.*','mode_paiements.*','type_paiements.*','boncommandes.*')
