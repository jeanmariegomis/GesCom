...
class BonCommandeController extends Controller
{
    ...
    public function getAllBoncommandes(){
        $AllBoncommandes = BonCommande::leftJoin('status', 'status.id_status', '=', 'bon_commandes.fk_status_bc')
    ...
    public function getPrixArticle_bc($fk_article){
     ...
     public function getBonCommande($id_bc){
        ...
        $boncommandes = BonCommande::leftJoin('comptes', 'bon_commandes.fk_compte_bc', '=', 'comptes.id_compte')
            ->leftJoin('status', 'bon_commandes.fk_status_bc', '=', 'status.id_status')
            ->select('bon_commandes.*', 'comptes.nom_compte','status.*')
            ->where('type_operation_bc','=',$request->type_operation_bc)
      ...
      public function  getBonCommandesCompte($idCompte){
        ...
        $boncommandes = BonCommande::leftJoin('comptes', 'bon_commandes.fk_compte_bc', '=', 'comptes.id_compte')
            ->leftJoin('status', 'bon_commandes.fk_status_bc', '=', 'status.id_status')
            ->select('bon_commandes.*', 'comptes.nom_compte','status.*')
            ->where('bon_commandes.fk_compte_bc','=', $idCompte)
            ->paginate(10);
